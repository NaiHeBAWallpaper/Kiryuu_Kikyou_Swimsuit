...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			...
			English: [
				...
				"Come on, enjoy it to the fullest."
			],
			Chinese: [
				"怎么样？还不错吧？",
				"为了今天特别制作的。",
	...
	},
	{
		time: 20000,
		count: 3,
		startTimes: [1300, 6800, 13300],
		dialog: {
			Japanese: [
				"実は……全部、初めてなんだ。",
				"何かを作っている時、誰かの顔が、ずっと浮かぶのも。",
				"無防備の姿を、誰かに見せるのも"
			],
			English: [
				"Actually... this is all my first time.",
				"When I'm making something, someone's face keeps appearing in my mind.",
				"And showing my defenseless side to someone."
			],
			Chinese: [
				"其实……这一切，都是第一次。",
				"不论是在制作时有谁的身影在脑海中挥之不去。",
				"还是向人展露毫无防备的姿态。"
			]
		}
	},
	{
		...
		dialog: {
			...
			English: [
				"It's not like... I'll say who it is though."
			],
			Chinese: [
				"具体是谁……我才不会说。"
			]
	...
	},
	{
		...
		dialog: {
			...
			English: [
				...
				"I'll protect what's next to you."
			],
			Chinese: [
				"……以后也要陪伴在我身边。",
				"你，就由我来守护。"
	...
	},
	{
		...
		dialog: {
			...
			English: [
				"...This alliance of ours is eternal."
			],
			Chinese: [
				"……我们之间的同盟，永恒不变。"
			]
...
const HITBOX = {
	headpat: { xMin: 300, xMax: 1020, yMin: 170, yMax: 550 },
	voiceline: { xMin: 1190, xMax: 2310, yMin: 560, yMax: 1300 }
};
